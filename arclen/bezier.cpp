...
namespace std {
template <typename FLOAT_TYPE> otv::arclen::v3<FLOAT_TYPE> sqrt(otv::arclen::v3<FLOAT_TYPE> v) {
    return otv::arclen::v3<FLOAT_TYPE>(std::sqrt(v.x), std::sqrt(v.y), std::sqrt(v.z));
}
} // namespace std
