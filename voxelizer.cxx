...
bool voxelizer::init(cgv::render::context& ctx, size_t count) {
	...
	success &= clamp_kernel.init(ctx, cgv::render::TT_3D, sl::ImageFormatLayoutQualifier::r32f, clamp);
	success &= fill_kernel.init(ctx, cgv::render::TT_3D, sl::ImageFormatLayoutQualifier::r32f);
